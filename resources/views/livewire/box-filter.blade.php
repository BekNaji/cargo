<div>
    <form class="mb-3" action="{{ route('admin.box.index') }}" method="GET">
        <input type="text" class="form-control" name="key" id="key" value="" placeholder="Filter">
            ...
            <div class="position-absolute bg-white shadow-lg w-100" style="height: 300px; z-index:99;">
                <div class="position-relative w-100 h-100">
                    ...
                    <div class="position-absolute bg-white shadow-sm " style="bottom:15px; right:15px;">
                        ...
                        <a type="submit" href="{{route('admin.box.index')}}" class="btn btn-primary btn-sm">{{__('Clear filter')}}</a>
